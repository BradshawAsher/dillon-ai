...
System Architecture:
Asynchronous "Factory" Backend: Built in n8n, the system uses a decoupled architecture where a webhook intake triggers a background sub-workflow, preventing timeouts.
