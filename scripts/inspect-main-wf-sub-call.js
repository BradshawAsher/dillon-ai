...
async function run() {
  ...
  console.log(`Main Workflow "${wf.name}":`)
  const subNode = wf.nodes.find(n => n.type === 'n8n-nodes-base.executeWorkflow')
  if (subNode) {
    console.log('Subworkflow Call Node Parameters:', JSON.stringify(subNode.parameters, null, 2))
  }
}
