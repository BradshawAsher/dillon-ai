...
export const medspaGroundTruth: ProjectSynthesisItem = {
    ...
    valuationBaseEstimate: '$3.12M',
    valuationUpperBound: '$3.75M',
    ...
    multiple: '4.0x',
    dealGrade: 'B+',
    companyName: 'MedSpa & Aesthetic Wellness Clinic',
    projectName: 'Business 5 - Medical Spa (Sameer)',
    aliases: [
        'project-20260803-cc15b25a',
        'medspa-wellness-clinic',
        'medspa',
        'medical spa',
        'sameer',
        'business 5',
