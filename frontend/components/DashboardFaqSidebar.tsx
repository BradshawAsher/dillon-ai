...
export default function DashboardFaqSidebar({
    ...
    const dashboardFaqs: Array<{
        ...
        },
        {
            ...
            answer: '• Tier 1: Quick Deal Screen (4 fields · 0 tokens · 1-second triage): Use when you only have a 1-page broker teaser or email summary. Calculates asking multiple, senior debt capacity, equity required, and basic DSCR viability instantaneously with zero LLM costs.\n• Tier 2: Detailed Questionnaire & Document Prefill (Assets, Debt, Add-backs, Customer Concentration): Use when you have a Confidential Information Memorandum (CIM) or 5–10 page financial packet. Generates an institutional LBO model, add-back quality haircuts, tangible book value, SBA 7(a) amortization schedule, and 3-scenario IRR returns.\n• Tier 3: Multi-Document AI Diligence Pipeline (Full File Upload · Raw PDFs & Excel): Use post-LOI with raw accounting files (Tax Returns Form 1120/1065, P&Ls, Balance Sheets, Bank Statements, AR/AP aging). Runs multi-model OCR extraction, proof-of-cash reconciliation, phantom revenue detection, and full Investment Committee Buy/Pass synthesis.',
            actionLabel: 'Open Questionnaire in Overview',
            targetTab: 'overview',
            badge: '3 DILIGENCE TIERS',
        },
        {
            category: 'getting-started',
            categoryLabel: 'Getting Started',
