...
export default function LoginButton() {
    ...
    // Always-visible isolation toggle — anyone can use this during MVP development
    const isolationButton = (
        <button
            type="button"
            onClick={toggleIsolation}
            className={`flex items-center gap-1 rounded-md border px-4 py-2 text-sm font-medium transition-colors ${isolation
...
{ isolation ? '⚠ Isolation ON — click to show all projects' : 'Isolation OFF' }
        </button >
    )
...
return (
    <div className="flex items-center gap-2">
        {isolationButton}
        <Button type="button" variant="outline" className="gap-2 px-5 py-3 text-base" onClick={() => setShowDialog(true)}>
