...
export const WORKSPACE_DEMOS: DemoItem[] = [
    ...
    },
    {
        ...
        category: 'Native Tour',
        duration: '~2.5 min',
        description: 'Underwrite a realistic Apex mock deal through the quick screen, local prefill, mocked AI review, and all five detailed sections.',
        status: 'active',
        icon: Calculator,
        badgeText: 'Full Mock Deal',
        badgeVariant: 'secondary',
    },
    {
        id: 'short-yt',
