...
export const WORKSPACE_DEMOS: DemoItem[] = [
    ...
    },
    {
        ...
        category: 'Native Tour',
        duration: '~4 min',
        description: 'Underwrite a realistic Apex mock deal, then follow its generated project through Overview, Diligence, Synthesis, and Projects.',
        status: 'active',
        icon: Calculator,
        badgeText: 'Full Project Journey',
        badgeVariant: 'secondary',
    },
    {
        id: 'short-yt',
