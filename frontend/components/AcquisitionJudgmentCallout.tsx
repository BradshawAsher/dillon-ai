import { Check, Copy, Download, ExternalLink, Link2, Mail, Pin, PinOff, Scale, X } from 'lucide-react'
...
export default function AcquisitionJudgmentCallout({
    ...
    const emailDraft = useMemo(() => {
        return buildDealEmailDraft({
            ...
            projectKey: projectId || synthesis?.projectId,
        })
    }, [model, synthesis, projectName, projectId])
    ...
    return (
        ...
        {/* Interactive Deal Email Draft Viewer Modal */}
        {isEmailModalOpen && (
                        ...
                        <div className="flex items-center gap-2.5">
                            ...
                            <div>
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Ready to send to investment committee, partners, or team members
                                </p>
                            </div>
                        </div>
                        <div className="flex items-center gap-2">
