...
const TAB_SECTIONS: Partial<Record<WorkspaceTab, TOCSection[]>> = {
    ...
    diligence: [
        { id: 'project-intake', label: 'File Intake Vault' },
        { id: 'latest-submission-section', label: 'Latest Document Submission' },
        { id: 'latest-doc-ai-summary', label: 'AI Summary & Thesis', indent: true },
        { id: 'diligence-document-flags', label: 'Document Risk Flags', indent: true },
        { id: 'diligence-project-synth', label: 'Fact Extraction' },
        { id: 'diligence-quality', label: 'Data Quality & Math' },
        { id: 'diligence-context', label: 'Deal Context & Checklist' },
    ],
    synthesis: [
        { id: 'synthesis-judgment', label: 'Acquisition Judgment (Start Here)' },
        { id: 'synthesis-valuation', label: 'Valuation Range (Low / Base / High)' },
    ...
    documents: [
        { id: 'projects-summary-metrics', label: 'Portfolio Summary KPIs' },
        { id: 'project-card-header', label: 'Active Deal Workspace' },
        { id: 'project-card-telemetry', label: 'AI Cost & Model Telemetry', indent: true },
        { id: 'project-card-documents', label: 'VDR Document Catalog' },
        { id: 'project-card-coverage', label: 'Coverage Checklist', indent: true },
        { id: 'project-card-summary-btn', label: 'High-Level Summary', indent: true },
    ],
    compare: [
        { id: 'compare-kpis', label: 'Portfolio KPIs & Pipeline' },
        { id: 'compare-filters', label: 'Search & Risk Filters' },
        { id: 'compare-matrix', label: 'Deal Comparison Matrix' },
    ],
    valuation: [
