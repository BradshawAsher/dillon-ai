...
export default function TechnicalFaqWorkspaceTab({ onSwitchTab }: TechnicalFaqWorkspaceTabProps) {
    ...
    const technicalFaqs = [
        ...
        },
        {
            ...
            answer: 'This button triggers the multi-document AI synthesis pass, which consolidates available findings, produces project-level risks and recommendations, and generates the downloadable IC deal memo. Deterministic cross-document ties require the same extracted metric and period in two files; customer concentration and debt coverage are calculated analyses rather than arithmetic verification.',
        ...
        },
        {
            ...
            answer: '1. Extract & Review Deal Financials: Surfaces cited Revenue, SDE, EBITDA, and margin facts from uploaded CIMs, P&Ls, and tax returns.\n2. Quality of Earnings (QoE) & Add-Back Review: Classifies seller add-backs by evidence quality and calculates user-adjustable haircut impacts; the labels are not a substitute for a QoE audit.\n3. Debt Structuring & DSCR Headroom: Computes debt coverage ratios under saved financing assumptions.\n4. Valuation & Multiple Analysis: Compares implied entry multiples against contextual SMB benchmarks and runs return sensitivities.\n5. Deep-Link Navigation: Directs you to specific workspace cards and anchors with targeted links.\n6. Cross-Document Discrepancy Review: Flags same-metric, same-period differences when the relevant numeric facts were extracted from independent documents.',
