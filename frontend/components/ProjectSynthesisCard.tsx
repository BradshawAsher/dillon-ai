...
import { downloadTextFile, fileSafeName, downloadSynthesisReport } from '../utils/downloadFile'
export { downloadSynthesisReport }
            ...
            <CardContent className="space-y-6 p-4">
                ...
                {[activeSynthesis].filter((s): s is ProjectSynthesisItem => Boolean(s)).map((synthesis) => {
                    ...
                    function handleInsightClick(groupType: InsightGroupType, item: string, index: number) {
                        ...
                        const structuredGroupMap: Record<InsightGroupType, StructuredFinding[]> = {
