        ...
        <>
            ...
            {isOpen && (
                <>
                    ...
                    <div className="fixed left-1/2 top-[25%] z-50 w-full max-w-sm -translate-x-1/2 -translate-y-1/2 rounded-lg border border-border bg-popover text-popover-foreground p-6 shadow-xl">
