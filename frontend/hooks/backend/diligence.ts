...
const mockSynthesisRow: ProjectSynthesisItem = {
    ...
    negotiationLevers: [
        'Revenue support verified across 2023-2025 P&Ls, Balance Sheet, LOI, and 13-sheet Financial Model.',
        'SDE normalized at $1,634,709 with full 100% audit-grade citation tracking.',
    ],
    keyTakeaways: [
        'Werkheiser Commercial Cleaning package verified across all 5 uploaded project materials.',
        'TTM Revenue of $3.77M and adjusted SDE of $1.63M confirmed against financial model and tax records.',
        '13-sheet financial due diligence model incorporates 24-month revenue/COGS breakdowns and owner salary add-backs.',
    ],
    redFlags: [],
    yellowFlags: ['Owner salary add-backs constitute major portion of SDE (~$505k).'],
    greenFlags: ['92% annual customer contract retention rate over 3 years; positive working capital.'],
    citations: [
    ...
    finalJudgmentSummary: 'Audit-grade commercial cleaning platform with stable recurring contracts, 13-sheet financial modeling validation, and verified $1.63M SDE.',
    finalJudgmentJson: '',
    aiErrorMessage: '',
    aiConfidence: '0.95',
    valuationConfidence: '0.92',
    valuationLowerBound: '$4.50M',
