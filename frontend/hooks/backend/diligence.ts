...
const mockSynthesisRow: ProjectSynthesisItem = {
    ...
    missingDocuments: ['General ledger / trial balance'],
    crossDocumentConflicts: [],
    openQuestions: [
        'Is the top-customer renewal executed or still in commercial review?',
    ],
    negotiationLevers: [
        'Revenue support verified against P&L tax schedule.',
    ],
    keyTakeaways: [
        'Werkheiser Commercial Cleaning package verified with 100% citation transparency.',
        'TTM Revenue of $2.73M and adjusted EBITDA of $682.5K confirmed against tax returns and P&L.',
        'Owner add-backs for personal auto and one-time legal fees fully validated.',
    ],
    redFlags: [],
    yellowFlags: ['Owner replacement salary needs formal management allocation.'],
    ...
    finalJudgmentSummary: 'Audit-grade commercial cleaning platform with stable recurring contracts and verified EBITDA.',
    finalJudgmentJson: '',
    aiErrorMessage: '',
    aiConfidence: '0.92',
