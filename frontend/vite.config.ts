...
export default defineConfig({
    ...
    rollupOptions: {
      output: {
        manualChunks(id) {
          ...
          if (id.includes('node_modules/react') || id.includes('node_modules/react-dom') || id.includes('node_modules/react-is') || id.includes('node_modules/react-router')) return 'vendor-react'
  ...
  test: {
    exclude: ['**/node_modules/**', '**/e2e/**', '**/integration/**', '**/dist/**'],
  },
})
