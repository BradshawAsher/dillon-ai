...
If the P&L and Tax Returns conflict, which document do you trust as the official source of truth?
...
Are there specific EBITDA adjustment categories we should explicitly look for?

When the AI escalates to "Human Review," what is the preferred notification method (Slack alert vs. Retool dashboard flag)?

What are the top 3 deal-killers you've encountered in the last 6 months that we should prioritize in our "red_flags" logic?
